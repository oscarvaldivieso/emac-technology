...
export default function HeroSection() {
  return (
    <section id="inicio" className="sticky top-0 min-h-screen w-full bg-gradient-to-br from-black via-gray-900 to-blue-900 flex items-center justify-center px-4 sm:px-6 pt-20 pb-12 sm:pt-24 overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-16 items-center">
          {/* Contenedor de texto */}
          <div className="w-full space-y-4 sm:space-y-6 lg:space-y-8 animate-fade-in lg:order-1">
            
            {/* Logo en móvil - aparece ANTES del título */}
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-2 sm:pt-3 justify-center lg:justify-start">
              <a 
                href="#servicios"
                className="group relative px-5 sm:px-6 py-2.5 sm:py-3 bg-white hover:bg-gray-100 text-black font-bold text-sm transition-all duration-300 hover:shadow-2xl hover:shadow-white/20 flex items-center justify-center gap-2"
              >
            ...
            <div className="pt-3 sm:pt-4 lg:pt-6 border-t border-white/10">
              <p className="text-xs text-gray-400 mb-2 sm:mb-3 text-center lg:text-left">Especializados en:</p>
